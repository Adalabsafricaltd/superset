import {
  AssistantSuggestionsGrid,
  AssistantSuggestionsGridProps,
} from './AssistantSuggestionsGrid';
...
export interface AssistantSuggestionCategoryProps
  extends AssistantSuggestionsGridProps {
  categoryTitle: string;
  categoryDescription: string;
 ...
 */
export function AssistantSuggestionCategory(
  props: AssistantSuggestionCategoryProps,
) {
      ...
      >
        ...
        >
          <img
            ...
            src="/static/assets/images/assistant_suggestion_icon.svg"
          />
        </div>
        <div
          style={{
