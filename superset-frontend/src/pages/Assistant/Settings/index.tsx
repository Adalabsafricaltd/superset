...
const Settings: React.FC<SettingsProps> = ({ isOpen, onClose }) => {
    ...
    <div>
      ...
      <Flex style={{ paddingInlineStart: 10, marginBottom: 15, marginTop: 15 }}>
        ...
        <p style={{ marginLeft: 10, fontSize: 18 }}>
          Enable Developer Logs Collection
        </p>
      </Flex>
    </div>
  );
  ...
  const text1 = (
    <h2 style={{ paddingInlineStart: 10, fontWeight: 'bold', fontSize: 20 }}>
  ...
  const subtext2 = (
    <p style={{ marginTop: 5, paddingInlineStart: 10, fontSize: 18 }}>
      Control how the assistant interprates your data
    </p>
  );
  const subtext3 = (
    <div>
      <p style={{ marginTop: 5, paddingInlineStart: 10, fontSize: 18 }}>
        Select what datasources the assistant has access to
      </p>
    </div>
  );
  const subtext4 = (
    <div>
      <p style={{ marginTop: 5, paddingInlineStart: 10, fontSize: 18 }}>
        Tell us how we can improve this feature
      </p>
    </div>
  );
  ...
  return (
    <>
      <Modal
        title={<h4>Assistant Settings</h4>}
        centered
        styles={{
          content: {
            background: 'white',
